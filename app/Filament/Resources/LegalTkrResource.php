...
use App\Filament\Resources\LegalTkrResource\Pages;
use App\Filament\Resources\LegalTkrResource\RelationManagers;
...
class LegalTkrResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListLegalTkrs::route('/'),
            'create' => Pages\CreateLegalTkr::route('/create'),
            'edit' => Pages\EditLegalTkr::route('/{record}/edit'),
        ];
    }
}
